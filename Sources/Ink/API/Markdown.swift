...
public struct Markdown {
    ...
    /// The View representation of the Markdown, ready to
    /// be rendered by SwiftUI
    public var viewWrappers: [MarkdownViewWrapper]
    ...
    internal init(html: String,
                  viewWrappers: [MarkdownViewWrapper],
                  titleHeading: Heading?,
                  metadata: [String : String]) {
        self.html = html
        self.viewWrappers = viewWrappers
